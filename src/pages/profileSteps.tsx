    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          className={'w-full border rounded-xl px-4 py-3 text-sm focus:outline-none resize-none theme-transition ' + (isDark ? 'bg-[#0d0d1a] border-gray-700 text-white focus:border-[#d4af37]' : 'bg-[#f0fdfa] border-[#14b8a6]/30 text-[#134e4a] focus:border-[#14b8a6]')}
          rows={2}
          placeholder="مثلاً: آسیب زانو راست، درد شانه چپ..."
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className={'w-full border rounded-xl px-4 py-3 text-sm focus:outline-none resize-none theme-transition ' + (isDark ? 'bg-[#0d0d1a] border-gray-700 text-white focus:border-[#d4af37]' : 'bg-[#f0fdfa] border-[#14b8a6]/30 text-[#134e4a] focus:border-[#14b8a6]')}
          rows={2}
          placeholder="مثلاً: عدم اسکات عمیق، محدودیت دامنه حرکت شانه..."
        />
      </div>
    </div>
  );
