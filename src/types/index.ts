...
export const GOAL_LABELS: Record<Goal, string> = {
  hypertrophy: 'عضله‌سازی (هایپرتروفی)',
...
export const BODY_COMPOSITION_LABELS: Record<string, string> = {
  lean: 'لاغر / کم‌چربی',
  athletic: 'ورزشی / عضلانی',
  average: 'متوسط',
...
export const JOB_STRESS_LABELS: Record<string, string> = {
  low: 'کم',
  moderate: 'متوسط',
  high: 'بالا',
};
